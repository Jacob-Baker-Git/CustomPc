      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-line gap-4">
          ...
          <select
            ...
            className="bg-surface-2 border border-line rounded-lg text-xs text-ink px-2 py-2 focus:outline-none focus:border-accent"
          >
        ...
        <div className="overflow-y-auto p-6 grid grid-cols-2 sm:grid-cols-3 gap-4">
          ...
          {hiddenCount > 0 && (
            <button
              ...
              className="col-span-full text-xs text-muted hover:text-accent border border-dashed border-line hover:border-accent rounded-lg py-2.5 transition-colors"
            >
