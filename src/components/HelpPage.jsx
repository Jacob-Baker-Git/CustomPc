...
const FAQS = [
  ...
  { q: 'What does compatibility checking cover?', a: 'Processor and motherboard sockets, DDR4 versus DDR5 memory, graphics card length against the case, air-cooler height against the case, and power supply headroom. Parts that would not fit stay visible but locked, with the reason. It catches common mistakes rather than every possible one — check the manufacturer\'s specifications before you buy.' },
