// AIO-style CPU cooler: a round pump block sitting on the CPU with a glowing
...
export default function CoolerModel() {
  return (
    <group>
      ...
      {/* glowing RGB ring on the pump face */}
      <mesh position={[0, 0.23, 0]} rotation={[Math.PI / 2, 0, 0]}>
        <torusGeometry args={[0.24, 0.028, 12, 40]} />
        <meshStandardMaterial color="#ec4899" emissive="#ec4899" emissiveIntensity={1.7} toneMapped={false} />
      </mesh>
