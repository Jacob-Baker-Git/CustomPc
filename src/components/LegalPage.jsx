      ...
      <div className="space-y-8">
        {doc.sections.map((s) => (
          <section key={s.heading}>
            <h2 className="text-lg font-semibold text-brass mb-2">{s.heading}</h2>
            {s.body.map((p, i) => (
        ...
        <section>
          <h2 className="text-lg font-semibold text-brass mb-2">Contact</h2>
          <p className="text-sm text-muted leading-relaxed">
            ...
            <a href="/feedback" className="text-brass hover:underline">feedback form</a>.
          </p>
        </section>
      </div>
