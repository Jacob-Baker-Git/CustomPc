...
// Beyond raw specs it derives context the card face can't show: what the part
// pairs with, what performance to expect, and where the numbers stop mattering.
import { RES_GPU } from '../lib/fpsEstimate'
  ...
  switch (part.category) {
    ...
    case 'monitor':
      return `To make full use of ${part.refresh}Hz you need ~${part.refresh} fps at ${part.resolution} — ` +
        'check the "How it runs" panel to see if your build keeps up.'
    case 'keyboard':
